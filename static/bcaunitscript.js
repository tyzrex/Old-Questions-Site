...
const createListItem = (question, asked) => {
  ...
  listItem.className = "text-lg py-3 text-white font-medium";
  ...
  askedLine.className = "text-green-400 bg-zinc-900 px-2 py-1 rounded-md";
  ...
  const copyButton = createButton(
    "Copy",
    "bg-zinc-900 text-white rounded-md px-2 py-1 ml-2 hover:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50",
    () => {
...
const clearButton = createButton(
  "Clear All Markings",
  "bg-red-700 text-white rounded-md mr-5 px-2 py-2 hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50"
);
...
const confusionsButton = createButton(
  "Get Confusions",
  "bg-gray-800 text-white rounded-md px-2 py-2 mr-4 hover:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50"
);
...
const randomQuestionButton = createButton(
  "Get Random Question",
  "bg-gray-800 text-white rounded-md px-2 py-2 hover:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50"
);
...
const fetchQuestions = async () => {
  try {
    const response = await fetch(`/unitwisequestions/bca/${filename}`);
